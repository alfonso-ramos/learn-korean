...
const Recurso = ({nombre, archivo}: RecursoProps) => (
    <a href={archivo} className="flex items-center gap-2 text-indigo-600 underline font-semibold hover:text-lg transition-all ease-in-out">
